...
module ActionView::Helpers::DateHelper
  def select_twelve_hour(datetime, options = {})
    ...
    select_html(options[:field_name] || 'hour', hour_options, options ) # options[:prefix], options[:include_blank], options[:discard_type], options[:disabled])
  end
  ...
  def select_am_pm(datetime, options = {})
    ...
    select_html(options[:field_name] || 'am_pm', am_pm_options, options ) # options[:prefix], options[:include_blank], options[:discard_type], options[:disabled])
  end
end
